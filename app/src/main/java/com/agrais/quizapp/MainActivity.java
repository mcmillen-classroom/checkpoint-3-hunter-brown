...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestions[0] = new Question(R.string.question_1,R.string.hint_1,true);
        mQuestions[1] = new Question(R.string.question_2,R.string.hint_2,true);
        mQuestions[2] = new Question(R.string.question_3,R.string.hint_3,true);
        mQuestions[3] = new Question(R.string.question_4,R.string.hint_4,true);
        mQuestions[4] = new Question(R.string.question_5,R.string.hint_5,false);
        mQuestions[5] = new Question(R.string.question_6,R.string.hint_6,true);
        mQuestions[6] = new Question(R.string.question_7,R.string.hint_7,false);
